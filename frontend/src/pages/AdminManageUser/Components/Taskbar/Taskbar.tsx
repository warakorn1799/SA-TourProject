...
function Taskbar() {
    ...
    return (
        <div className={styles.header}>
            <Button className={styles.btn_item2} style={{ marginTop: 20 }}
            ...
            <Button style={{ borderRadius: 0, textDecoration: 'none', height: 90, background: 'rgba(252.01, 97.19, 48.30, 0.25)', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }} block type='text'
